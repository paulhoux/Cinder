...
public:
	...
	static HRESULT CreateInstance( _In_ REFIID iid, _COM_Outptr_ void** ppSink, DirectXVersion dxVersion = DX_11 );
...
private:
	...
	MediaSink( DirectXVersion dxVersion );
