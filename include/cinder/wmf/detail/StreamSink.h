...
#include "cinder/wmf/detail/Marker.h"
...
class __declspec( uuid( "FCB11007-A68C-4383-8640-9887BBE597E8" ) ) StreamSink : public IMFStreamSink,
  ...
  private:
	...
	// IMPORTANT: if you add or remove states here, be sure to also update ValidStateMatrix!
	enum State {
	...
	// IMPORTANT: if you add or remove operations here, be sure to also update ValidStateMatrix!
	...
	class __declspec( uuid( "0A2DF44B-3108-44F2-B5A8-0D85B4273CD2" ) ) AsyncOperation : public msw::ComObject {
	  public:
