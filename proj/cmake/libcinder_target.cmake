...
if( CINDER_MSW )
    ...
    set_target_properties( cinder PROPERTIES 
        ...
        LINK_FLAGS_DEBUG						"${CINDER_STATIC_LIBS_DEPENDS_DEBUG}"
        LINK_FLAGS_RELEASE						"${CINDER_STATIC_LIBS_DEPENDS_RELEASE}"
        LINK_FLAGS_MINSIZEREL					"${CINDER_STATIC_LIBS_DEPENDS_RELEASE}"
        LINK_FLAGS_RELWITHDEBINFO				"${CINDER_STATIC_LIBS_DEPENDS_RELEASE}"
    )    
elseif( CINDER_MAC )
    set( OUTPUT_DIRECTORY_BASE "${CINDER_PATH}/lib/${CINDER_TARGET_SUBFOLDER}" )
    set_target_properties( cinder PROPERTIES 
