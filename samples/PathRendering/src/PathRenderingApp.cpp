...
class PathRenderingDevApp : public App {
  public:
...
CINDER_APP( PathRenderingDevApp, RendererGl( RendererGl::Options().colorChannelDepth( 8 ) ), &PathRenderingDevApp::prepare )
